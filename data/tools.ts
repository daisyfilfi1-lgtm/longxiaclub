...
const AI_ENHANCED_CONTENT: Record<string, {
  ...
  deepseek: {
    tips: [
      '上下文长度达1M tokens，可处理超长文档',
      '代码能力在开源模型中领先',
      '完全免费无需翻墙',
      '使用"角色扮演"技巧：先给DeepSeek设定角色（如资深程序员），再提问，可获得更专业的回答',
      '利用"Few-shot Learning"：在提问时给出几个示例，让DeepSeek理解你想要的输出格式',
    ],
    cases: [
      { title: '专业文案创作', description: '使用DeepSeek生成高质量营销或品牌文案', prompt: '请帮我撰写一篇关于[产品或主题]的专业文案，要求：1. 明确目标受众 2. 突出核心卖点 3. 包含Call to Action 4. 语气与品牌调性一致' },
      { title: '数据分析与洞察', description: '用DeepSeek分析数据并生成可读报告', prompt: '请分析以下数据，给出：1. 关键发现和数据趋势 2. 异常点和可能的原因 3. 可执行的业务建议 4. 下一步行动计划\n数据：[粘贴数据]' },
      { title: '知识学习助手', description: '用DeepSeek辅助学习新知识领域', prompt: '请作为[领域]专家，用通俗易懂的方式向我解释以下概念：\n1. 核心定义\n2. 工作原理\n3. 实际应用场景\n4. 与其他相关概念的关系\n概念：[填写概念名称]' },
    ],
    guides: [
      { title: '新手入门指南', steps: [
        '访问 DeepSeek 的官网并注册账号',
...
export const tools: Tool[] = [
  ...
  { id: 'cursor', name: 'Cursor', logo: '⌨️', description: 'AI原生代码编辑器，深度集成AI辅助编程体验', url: 'https://cursor.sh', price: 'freemium', difficulty: 'intermediate', heat: 75.6, heatGrowth: 31.2, tags: ['代码编辑器', 'AI编程', '开发工具'], techTags: ['GenerativeAI', 'CodeGen'], sceneTags: ['编程开发'], costTags: ['Freemium', '需翻墙'], category: '编程开发', prompts: [{ id: 'p1', title: '代码生成', content: '请生成一个[功能描述]的[编程语言]函数，要求：遵循最佳实践、包含错误处理、添加详细注释', scene: '编程开发' }, { id: 'p2', title: '代码重构', content: '请重构以下代码，提升可读性和性能，同时保持功能不变：[代码]', scene: '编程开发' }], tips: ['Ctrl+K 快速编辑选中代码', 'Ctrl+L 对话式编程助手', '支持多文件上下文理解和跨文件重构'], relatedSkills: ['skill_code_review'] },
  ...
  { id: 'deepseek', name: 'DeepSeek', logo: '🧠', description: '中国AI大模型，性能卓越的对话和代码助手', url: 'https://chat.deepseek.com', price: 'free', difficulty: 'beginner', heat: 71.8, heatGrowth: 52.4, tags: ['AI对话', '代码助手', '长文本'], techTags: ['NLP', 'GenerativeAI'], sceneTags: ['编程开发', '办公提效', '学术研究', '企业AI自动化'], costTags: ['Free', '中文友好'], category: 'AI对话', prompts: [{ id: 'p1', title: '编程问题解决', content: '请帮我解决这个编程问题：[描述问题]\n相关代码：[代码片段]', scene: '编程开发' }, { id: 'p2', title: '长文档分析', content: '请分析以下文档，提取关键信息：[文档内容]', scene: '办公提效' }], tips: ['上下文长度达1M tokens，可处理超长文档', '代码能力在开源模型中领先', '完全免费无需翻墙'], relatedSkills: ['skill_code_review', 'skill_weekly_report'] },
