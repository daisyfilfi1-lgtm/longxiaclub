...
export default function ComparePage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'ChatGPT vs DeepSeek', item: 'https://longxiaclub.com/compare/chatgpt-vs-deepseek' },
    ],
  };
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'ChatGPT和DeepSeek哪个更好？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ChatGPT和DeepSeek各有优势，具体选择取决于你的使用场景。ChatGPT在某些方面更出色，DeepSeek在其他方面更强。建议根据你的具体需求选择最适合的工具。'
        }
      },
      {
        '@type': 'Question',
        name: 'ChatGPT和DeepSeek的价格对比如何？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ChatGPT和DeepSeek的定价模式不同。请查看页面中的价格对比表获取详细信息。'
        }
      },
      {
        '@type': 'Question',
        name: 'ChatGPT和DeepSeek分别适合什么场景？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ChatGPT适合特定的使用场景和用户群体，DeepSeek则在不同场景下表现更好。本文详细对比了两者在各个维度的表现。'
        }
      },
      {
        '@type': 'Question',
