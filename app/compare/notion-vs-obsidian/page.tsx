...
export default function ComparePage() {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Notion AI和Obsidian AI哪个更好？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Notion AI和Obsidian AI各有优势，具体选择取决于你的使用场景。Notion AI在某些方面更出色，Obsidian AI在其他方面更强。建议根据你的具体需求选择最适合的工具。'
        }
      },
      {
        '@type': 'Question',
        name: 'Notion AI和Obsidian AI的价格对比如何？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Notion AI和Obsidian AI的定价模式不同。请查看页面中的价格对比表获取详细信息。'
        }
      },
      {
        '@type': 'Question',
        name: 'Notion AI和Obsidian AI分别适合什么场景？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Notion AI适合特定的使用场景和用户群体，Obsidian AI则在不同场景下表现更好。本文详细对比了两者在各个维度的表现。'
        }
      },
      {
        '@type': 'Question',
