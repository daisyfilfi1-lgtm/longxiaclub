...
export default function ComparePage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'AI导航站', item: 'https://longxiaclub.com' },
      { '@type': 'ListItem', position: 2, name: '工具对比', item: 'https://longxiaclub.com/compare' },
      { '@type': 'ListItem', position: 3, name: 'OpenClaw vs Hermes', item: 'https://longxiaclub.com/compare/openclaw-vs-hermes' },
    ],
  };
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'OpenClaw和Hermes哪个更好？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'OpenClaw和Hermes各有优势，具体选择取决于你的使用场景。OpenClaw在某些方面更出色，Hermes在其他方面更强。建议根据你的具体需求选择最适合的工具。'
        }
      },
      {
        '@type': 'Question',
        name: 'OpenClaw和Hermes的价格对比如何？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'OpenClaw和Hermes的定价模式不同。请查看页面中的价格对比表获取详细信息。'
        }
      },
      {
        '@type': 'Question',
        name: 'OpenClaw和Hermes分别适合什么场景？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'OpenClaw适合特定的使用场景和用户群体，Hermes则在不同场景下表现更好。本文详细对比了两者在各个维度的表现。'
        }
      },
      {
        '@type': 'Question',
