...
export default function ComparePage() {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'Perplexity和Google Gemini哪个更好？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Perplexity和Google Gemini各有优势，具体选择取决于你的使用场景。Perplexity在某些方面更出色，Google Gemini在其他方面更强。建议根据你的具体需求选择最适合的工具。'
        }
      },
      {
        '@type': 'Question',
        name: 'Perplexity和Google Gemini的价格对比如何？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Perplexity和Google Gemini的定价模式不同。请查看页面中的价格对比表获取详细信息。'
        }
      },
      {
        '@type': 'Question',
        name: 'Perplexity和Google Gemini分别适合什么场景？',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Perplexity适合特定的使用场景和用户群体，Google Gemini则在不同场景下表现更好。本文详细对比了两者在各个维度的表现。'
        }
      },
      {
        '@type': 'Question',
