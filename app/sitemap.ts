...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/trends`, changeFrequency: 'daily' as const, priority: 0.8, lastModified: now },
    { url: `${baseUrl}/trends/leaderboard`, changeFrequency: 'daily' as const, priority: 0.8, lastModified: now },
    { url: `${baseUrl}/trends/producthunt`, changeFrequency: 'daily' as const, priority: 0.7, lastModified: now },
    { url: `${baseUrl}/trends/github`, changeFrequency: 'daily' as const, priority: 0.7, lastModified: now },
